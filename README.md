    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                Copyright &copy;2023 Developed by SURENDAR</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/sanz.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .manph2{
            background-image: url(/static/images/nagarajan.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/sanjith.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/kalai.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>SURENDAR</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>SRIRAJ</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>PON NAGARAJAN</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>SHARAN</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>SANJITH</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>KALAI KUMAR</h2></b></p></div><br>
            ...
            <div class="header">
                ...
                <div class="content">
                    ...
                    <ul>
                        ...
                        <li><b>Facebook</b>: fb/sanzfancyworld</li>
                        <li><b>Email Id:</b>Surendarnehru2004@gmail.com</li>
                    </ul>
